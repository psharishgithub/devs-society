...
// @access  Private
router.put('/profile', auth_1.default, upload.single('photo'), async (req, res) => {
    try {
        ...
        if (req.file) {
            ...
            try {
                ...
                const uploadResult = await supabaseStorage_1.default.updateProfilePhoto(req.file.buffer, req.file.originalname, req.user.id, updates.photoUrl // Pass old photo URL for cleanup
                );
